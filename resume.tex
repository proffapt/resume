...
% --- Have better Activities & Leadership section
 ...
 % \begin{tabular}{r|p{15cm}}
 % \textsc{Completed} & \href{https://github.com/proffapt/iitkgp-pds-lab }{Programming And Data Structures (T/L)} | Linear Algebra, Numerical and Complex Analysis (T) | DIY (L) | Basic Electronics (T/L) | Probability and Statistics (T) | Operations Research-I (T) | Operations Research-II (T/L) | Simulation (T/L)
 % \end{tabular}
 %------
